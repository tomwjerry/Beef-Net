...
namespace Beef_Net
{
	...
	sealed static class WinSock2
	{
        ...
        public extern static uint32 FormatMessageA(uint32 dwFlags, void* lpSource, uint32 dwMessageId, uint32 dwLanguageId, char8* lpBuffer, uint32 nSize, void* Arguments);
    
        [Import("kernel32.dll"), CLink, CallingConvention(.Stdcall)]
        public extern static uint32 FormatMessageW(uint32 dwFlags, void* lpSource, uint32 dwMessageId, uint32 dwLanguageId, char16* lpBuffer, uint32 nSize, void* Arguments);
	}
#endif
}
